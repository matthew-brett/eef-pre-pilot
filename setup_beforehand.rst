...
started using the `Python language <https://www.python.org>`_ for data
analysis.  All the packages we will be using are free and open-source;
Anaconda is just a platform that makes it easy to install these packages on
your computer.
...
* Choose your operating system (Windows, Mac, Linux):
  ...
  .. image:: images/anaconda_platforms.png
...
* Choose the Python 3.6 64-bit graphical installer, unless you know you need a
  ...
  .. image:: images/anaconda_python36.png
...
* Now follow the install instructions for your operating system:
  ...
  * `Install on Windows
    <https://docs.anaconda.com/anaconda/install/windows>`_.
  * `Install on Mac
    <https://docs.anaconda.com/anaconda/install/mac-os#macos-graphical-install>`_.
  * `Install on Linux
    <https://docs.anaconda.com/anaconda/install/linux>`_.
